	...
	<div class="container">
		<div class="col-md-12">
			<ol class="breadcrumb">
			  ...
			  <li class="active">Checkout - Payment method</li>
			</ol>
		</div>  <!-- end breadcrumb --->
	</div>
	...
	<div class="col-md-9" >
		<form method="post" action="checkout4.html">
			<div class="panel panel-my" id="basket">
				...
				<div class="panel-footer">
					<div class="pull-left">
						<a href="checkout2.html" class="btn btn-default"><i class="fa fa-chevron-left"></i> Back </a>
					</div>
					<div class="pull-right">
						<a href='{{route('checkout4')}}' type="submit" class="btn btn-my">Continue to Order Review <i class="fa fa-chevron-right"></i>
						</a>
					</div>
